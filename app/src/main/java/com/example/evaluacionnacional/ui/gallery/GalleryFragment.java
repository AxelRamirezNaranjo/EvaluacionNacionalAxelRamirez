    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (user != null) {
            ...
            if (photoUrl != null) {
                ...
                Picasso.get()
                        .load(photoUrl)
                        .placeholder(R.drawable.usuarioxd)  // Imagen por defecto mientras carga
                        .error(R.drawable.usuarioxd)  // Imagen en caso de error
                        .into(profileImageView);
            } else {
                // Imagen predeterminada si no hay foto
                profileImageView.setImageResource(R.drawable.usuarioxd);
            }
